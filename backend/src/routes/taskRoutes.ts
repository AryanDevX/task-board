...
import { createTask, getTask, updateTask, moveTask, deleteTask } from '../controllers/taskController.js';
...
//read
router.get('/:taskId', authenticateJWT, requireProjectRole(["PROJECT_ADMIN", "PROJECT_MEMBER", "PROJECT_VIEWER"]), getTask);
