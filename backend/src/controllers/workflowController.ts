...
export const getTransitions = async (req:Request, res:Response, next:NextFunction): Promise<void>=>{
    try{
...
export const updateTransitions = async (req:Request, res:Response, next:NextFunction): Promise<void> =>{
    try{
        const {boardId} = req.params;
